...
awful.keyboard.append_global_keybindings({
	...
	awful.key({ modkey }, "Return", function() awful.spawn(user_likes.term) end,
		{ description = "open terminal", group = "launcher" }),

	awful.key({ modkey }, "n", function() awful.spawn(user_likes.files) end,
		{ description = "open nautilus", group = "launcher" }),

	awful.key({ modkey }, "m", function() awful.spawn(user_likes.music) end,
		{ description = "launch music client", group = "launcher" }),

	awful.key({ modkey }, "b",
		function() awful.spawn.with_shell(user_likes.web) end,
		{ description = "open web browser", group = "launcher" }),

	awful.key({ modkey }, "d", function() awful.spawn(misc.rofiCommand) end,
	...
	awful.key({ modkey }, "/", function() lock_screen_show() end,
...
awful.keyboard.append_global_keybindings({
	...
	awful.key({ modkey }, "F2", function() misc.musicMenu() end,
...
awful.keyboard.append_global_keybindings({
	...
	-- layout machi
	awful.key({ modkey }, ".",
		function() lmachi.default_editor.start_interactive() end,
		{ description = "edit current layout", group = "layout" }),

	awful.key({ modkey, shift }, ".",
		function() lmachi.switcher.start(client.focus) end, {
...
client.connect_signal("request::default_keybindings", function()
	awful.keyboard.append_client_keybindings({
		awful.key({ alt }, "c", function(c)
			c.fullscreen = not c.fullscreen
			c:raise()
		end, { description = "toggle fullscreen", group = "client" }),

		awful.key({ ctrl }, "q", function(c) c:kill() end,
		...
		awful.key({ alt }, "n", function(c) c.minimized = true end,
