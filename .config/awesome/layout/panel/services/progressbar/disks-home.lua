...
local disks_home_bar = awful.widget.watch('bash /home/rwietter/.config/awesome/scripts/disk-home-size.sh', 59,
	function(wid, stdout)
...
local disks_home_text = awful.widget.watch('bash ' .. home_var .. '/.config/awesome/scripts/disk-home-size.sh'
